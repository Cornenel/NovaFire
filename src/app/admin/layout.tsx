    ...
    <div className="min-h-screen nf-bg-base">
      <header className="sticky top-0 z-40 border-b border-white/[0.06] bg-[#0c0c0c]/95 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-3 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <Link
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm text-violet-300 hover:text-white hover:bg-violet-500/10 border border-violet-500/20 transition-colors"
              >
                Client Portal
              </Link>
              <Link
              ...
              >
                ...
                <span className="hidden sm:inline">Tech App</span>
              </Link>
              <form action={signOut}>
                <button
                  type="submit"
          ...
          <div className="pb-2 border-t border-white/[0.04] pt-2 overflow-x-auto">
            <AdminNav />
          </div>
        </div>
      </header>
